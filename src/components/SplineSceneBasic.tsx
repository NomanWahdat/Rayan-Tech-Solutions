       ...
       <div className="flex flex-col md:flex-row h-full">
        ...
        <div className="w-full md:flex-1 p-2 md:p-10 relative z-10 flex flex-col justify-start md:justify-center">
          ...
          <h1 className="text-lg md:text-4xl lg:text-5xl font-extrabold leading-tight mb-1 md:mb-2">
            ...
            <span className="text-white block text-base md:text-3xl lg:text-4xl">Software House for Visionary Teams</span>
          </h1>
          ...
          <div className="mt-2 md:mt-6 flex flex-col md:flex-row gap-1.5 md:gap-3">
            <a href="#portfolio" className="px-3 py-1 md:py-3 md:px-6 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full text-white font-semibold text-[11px] md:text-base text-center">View Our Work</a>
            <a href="#contact" className="px-3 py-1 md:py-3 md:px-6 bg-white/10 rounded-full text-white font-semibold border border-white/20 text-[11px] md:text-base text-center">Start a Project</a>
          </div>
